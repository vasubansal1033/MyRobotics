...
% first create points from a unit sphere; this actually has to be from a 6D
% space, but we're doing a trick here to simplify it. For the n-shpere
% equations and spherical coordinates in higher dimensions, see: https://en.wikipedia.org/wiki/N-sphere
